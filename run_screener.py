...
• Volume profile turns constructive"""
                                ...
                                st.markdown(f"""
<div style='background: linear-gradient(135deg, #f8f9fa 0%, #e9ecef 100%); padding: 1.5rem; border-radius: 10px; border-left: 6px solid #5c6bc0; margin: 0.5rem 0 1rem 0; box-shadow: 0 2px 8px rgba(92,107,192,0.15);'>
    <div style='font-size: 1.3rem; font-weight: 700; color: #3f51b5; margin-bottom: 0.75rem; line-height: 1.3;'>
        {final_action['label']}
    </div>
    <div style='font-size: 0.95rem; color: #495057; font-weight: 500; margin-bottom: 1.25rem; line-height: 1.5;'>
        {final_action['reason']}
    </div>
...
{trigger_list}
    ...
    <div style='display: grid; grid-template-columns: repeat(3, 1fr); gap: 0.75rem; margin-bottom: 1rem;'>
        <div style='background: rgba(255,255,255,0.9); padding: 0.75rem; border-radius: 6px; text-align: center;'>
            <div style='font-size: 0.7rem; color: #6c757d; font-weight: 600; text-transform: uppercase; letter-spacing: 0.5px; margin-bottom: 0.25rem;'>
                FUND SCORE
            </div>
            <div style='font-size: 1.5rem; font-weight: 700; color: #3f51b5;'>
                {fund_score:.0f}/100
            </div>
            <div style='font-size: 0.75rem; color: #6c757d; margin-top: 0.25rem;'>
